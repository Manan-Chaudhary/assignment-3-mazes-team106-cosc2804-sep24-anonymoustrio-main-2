...
void printTeamInfo(void){
   ...
   // std::cout << "\t [1] Sakitha Sanvidu (s4035640@student.rmit.edu.au)" << std::endl;
    std::cout << "\t [2] Manan Chaudhary (s4027498@student.rmit.edu.au)" << std::endl;
    std::cout << "\t [3] Divyansh Sharma (s4040936@student.rmit.edu.au)" << std::endl;
